...
#Creates an Isaac Sim OmniGraph that publishes the current simulation time to the ROS 2 /clock topic 
# on Domain ID 1 whenever an impulse event is triggered.
